...
export const PUBLIC_FAQS = [
  {
    question: 'Are all ventures NUDA / DTCP and AP RERA approved?',
    questionTe: 'అన్ని లేఅవుట్‌లు NUDA / DTCP మరియు AP RERA ఆమోదం పొందాయా?',
    ...
    answerTe: 'అవును, మా అన్ని ప్రాజెక్టులు NUDA లేదా DTCP మరియు ఆంధ్రప్రదేశ్ RERA ద్వారా 100% క్లియర్ టైటిల్‌తో ఆమోదించబడ్డాయి.',
  },
  {
    question: 'Do you arrange free cabs for site visits in Nellore?',
    questionTe: 'నెల్లూరులో సైట్ విజిట్ కొరకు ఉచిత క్యాబ్ సౌకర్యం ఉందా?',
    ...
    answerTe: 'అవును! నెల్లూరులో మీ ఇంటి నుండే ఉచిత ఏసీ క్యాబ్ పికప్ & డ్రాప్ సౌకర్యం కల్పిస్తున్నాము.',
  },
  {
    question: 'Are bank loans available for open plots in Nellore?',
    questionTe: 'నెల్లూరులో ఓపెన్ ప్లాట్ల కొరకు బ్యాంక్ లోన్స్ లభిస్తాయా?',
    answer: 'Yes, all our ventures are pre-approved by leading financial institutions including SBI, HDFC, ICICI, and Union Bank for plot purchase loans up to 75%.',
    answerTe: 'అవును, SBI, HDFC, ICICI మరియు యూనియన్ బ్యాంకుల ద్వారా 75% వరకు ప్లాట్ లోన్స్ అందుబాటులో ఉన్నాయి.',
  },
  {

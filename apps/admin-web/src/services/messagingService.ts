...
const DEFAULT_SYSTEM_NOTIFICATIONS: SystemNotificationItem[] = [
  {
    id: 'notif-001',
    userId: 'all',
    title: 'New Plot Booking Completed: Grand City Block B-12',
  ...
  },
  {
    ...
    message: 'Premium investor inquiry from Cyberabad for "Green Meadows Villa Plots" assigned to Telecaller Team.',
    type: 'lead',
    severity: 'info',
    read: false,
  ...
  'conv-cgm-leadership-forum': [
    {
      ...
      subject: 'Grand City Venture Zone Launch',

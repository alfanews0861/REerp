  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          id: 'NET-005',
          name: 'Anil Kumar',
          role: 'General Manager (GM - Financial District)',
          phone: '+91 98480 45678',
          email: 'anil.k@realestate.com',
          teamSize: 14,
          totalVolume: '₹5.1 Cr',
          status: 'Active',
          level: 3,
    ...
    },
    {
      id: 'NET-003',
      name: 'Suresh Babu',
      role: 'Chief General Manager (CGM - South Zone)',
      phone: '+91 98480 78901',
      email: 'suresh.babu@realestate.com',
      teamSize: 26,
      totalVolume: '₹8.9 Cr',
      status: 'Active',
      level: 2,
      children: [
        {
          id: 'NET-008',
          name: 'Sunita Patel',
          role: 'General Manager (GM - Airport Corridor)',
          phone: '+91 98480 89012',
          email: 'sunita.p@realestate.com',
          teamSize: 12,
          totalVolume: '₹4.5 Cr',
          status: 'Active',
          level: 3,
          children: [
            {
              ...
              email: 'sudhakar.g@realestate.com',
              teamSize: 4,
              totalVolume: '₹1.8 Cr',
              status: 'Active',
              level: 4,
        ...
        },
        {
          ...
          role: 'General Manager (GM - Shadnagar Corridor)',
          phone: '+91 98480 89013',
          email: 'venkatesh.c@realestate.com',
          teamSize: 11,
          totalVolume: '₹3.9 Cr',
          status: 'Active',
          level: 3,
    ...
    },
    {
      id: 'NET-020',
      name: 'Murali Mohan',
      role: 'Chief General Manager (CGM - West Zone & Mokila)',
      phone: '+91 98480 91001',
      email: 'murali.mohan@realestate.com',
      teamSize: 22,
      totalVolume: '₹7.7 Cr',
      status: 'Active',
      level: 2,
      children: [
        {
          id: 'NET-021',
          name: 'Radhika Nair',
          role: 'General Manager (GM - Shankarpally Highway)',
          phone: '+91 98480 91002',
          email: 'radhika.n@realestate.com',
          teamSize: 10,
          totalVolume: '₹3.8 Cr',
          status: 'Active',
          level: 3,
          children: [
            {
              id: 'NET-022',
              name: 'Praveen Teja',
              role: 'Senior Sales Manager (SSM - Mokila)',
              phone: '+91 98480 22335',
              email: 'praveen.t@realestate.com',
              teamSize: 5,
              totalVolume: '₹2.2 Cr',
              status: 'Active',
              level: 4,

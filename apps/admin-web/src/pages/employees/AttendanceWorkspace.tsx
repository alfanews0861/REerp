...
export const SEED_ATTENDANCE: AttendanceRecord[] = [
  {
    ...
    assignedLocationName: 'Corporate HQ (Annamayya Circle, Nellore)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T08:30:00Z`,
    isGeoFenceVerified: true,
    status: 'PRESENT',
    workSummary: 'Executive Board review meeting, investor syndicate discussion for ISKON City - 2 Phase 2.',
  ...
  },
  {
    ...
    assignedLocationName: 'ISKON City - 2 Site Office (Podalakur Road)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T08:45:00Z`,
    isGeoFenceVerified: true,
    status: 'ON_FIELD_DUTY',
    workSummary: 'Inspecting NUDA layout demarcation, 170 ft entrance road, clubhouse foundation, and avenue plantation.',
    totalHoursWorked: 9,
  ...
  },
  {
    ...
    userRole: 'Branch Manager (Mini Bypass)',
    staffType: 'OFFICE_STAFF',
    assignedLocationName: 'Mini Bypass Branch Office',
    branchId: 'branch-2',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T09:00:00Z`,
    isGeoFenceVerified: true,
    status: 'PRESENT',
    workSummary: 'Conducted weekly sales review with Mini Bypass team. Finalized 4 NRI token closures.',
  ...
  },
  {
    ...
    userRole: 'Branch Manager (Annamayya Circle)',
    staffType: 'OFFICE_STAFF',
    assignedLocationName: 'Head Office (RKRI Towers, Nellore)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
  ...
  },
  {
    ...
    staffType: 'OFFICE_STAFF',
    assignedLocationName: 'Finance Wing (Nellore HO)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
  ...
  },
  {
    ...
    userRole: 'Zonal Sales Head (Nellore & Coastal AP)',
    staffType: 'FIELD_STAFF',
    assignedLocationName: 'ISKON City - 2 (Podalakur Road)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T09:05:00Z`,
    isGeoFenceVerified: true,
    status: 'PRESENT',
    workSummary: 'Hosted high-ticket NRI investor delegation. Closed plot #IC-102 and villa plot #DC-05.',
  ...
  },
  {
    ...
    staffType: 'FIELD_STAFF',
    assignedLocationName: 'Dream City Villa Plots (Kovuru Highway)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
  ...
  },
  {
    ...
    isGeoFenceVerified: true,
    status: 'PRESENT',
    workSummary: 'Coordinated 3 family site visits from Nellore town; collected 2 booking advances.',
    totalHoursWorked: 8.5,
  ...
  },
  {
    ...
    staffType: 'FIELD_STAFF',
    assignedLocationName: 'ISKON Brundhavanam (Chinthareddypalem)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T09:15:00Z`,
    isGeoFenceVerified: true,
  ...
  },
  {
    ...
    isGeoFenceVerified: true,
    status: 'PRESENT',
    workSummary: 'Optimizing Meta ads CPL to ₹34, launched NRI Gulf investment video campaign for ISKON City - 2.',
    totalHoursWorked: 8.5,
    createdAt: '2026-09-09T09:10:00Z',
    updatedAt: '2026-09-09T09:10:00Z',
  },
  {
    ...
    isGeoFenceVerified: true,
    status: 'PRESENT',
    workSummary: 'A/B testing landing page copy for Dream City villa plots; created Google ad variants.',
    totalHoursWorked: 8.0,
  ...
  },
  {
    ...
    staffType: 'FIELD_STAFF',
    assignedLocationName: 'Outdoor Canopy Stalls (VRC Centre, Nellore)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T10:05:00Z`,
    isGeoFenceVerified: true,
    status: 'LATE',
    workSummary: 'Setting up Sunday property expo booth at Nellore Town Centre.',
  ...
  },
  {
    ...
    isGeoFenceVerified: true,
    status: 'PRESENT',
    workSummary: 'Conducted 68 outbound HNI calls; scheduled 11 weekend site visits for ISKON City - 2.',
    totalHoursWorked: 8.0,
    createdAt: '2026-09-09T09:20:00Z',
    updatedAt: '2026-09-09T09:20:00Z',
  },
  {
    ...
    staffType: 'OFFICE_STAFF',
    assignedLocationName: 'Mini Bypass Call Center',
    branchId: 'branch-2',
    date: new Date().toISOString().split('T')[0],
  ...
  },
  {
    ...
    staffType: 'FIELD_STAFF',
    assignedLocationName: 'Innova Crysta (AP 26 UB 1001)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T08:30:00Z`,
    isGeoFenceVerified: true,
    status: 'ON_FIELD_DUTY',
    workSummary: 'Morning pickup from Annamayya Circle to ISKON City - 2 site with NRI customer family.',
    totalHoursWorked: 9.0,
    createdAt: '2026-09-09T08:30:00Z',
    updatedAt: '2026-09-09T08:30:00Z',
  },
  {
    ...
    staffType: 'FIELD_STAFF',
    assignedLocationName: 'Force Tempo Traveller (AP 26 EX 4050)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T08:45:00Z`,
    isGeoFenceVerified: true,
    status: 'ON_FIELD_DUTY',
    workSummary: 'Group tour of 14 investors to ISKON City - 2 Podalakur Road.',
    totalHoursWorked: 9.5,
    createdAt: '2026-09-09T08:45:00Z',
    updatedAt: '2026-09-09T08:45:00Z',
  },
  {
    ...
    staffType: 'FIELD_STAFF',
    assignedLocationName: 'Maruti Suzuki Ertiga (AP 26 HK 2020)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],
    punchInTime: `${new Date().toISOString().split('T')[0]}T09:00:00Z`,
    isGeoFenceVerified: true,
    status: 'PRESENT',
    workSummary: 'Site visit with Dr. Anand Swamy to Dream City Kovuru.',
    totalHoursWorked: 8.5,
    createdAt: '2026-09-09T09:00:00Z',
    updatedAt: '2026-09-09T09:00:00Z',
  },
  {
    ...
    staffType: 'FIELD_STAFF',
    assignedLocationName: 'Mahindra Scorpio-N (AP 26 Z 8899)',
    branchId: 'branch-1',
    date: new Date().toISOString().split('T')[0],

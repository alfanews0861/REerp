...
export const SEED_EXPENSES: ExpenseClaim[] = [
  {
    ...
    category: 'SITE_VISIT',
    title: 'Customer Site Visit Refreshments & Lunch - Sunrise Enclave',
    description: 'Refreshments and lunch provided for 8 visiting NRI families at Mokila site office.',
    amount: 4850,
    ...
    linkedSiteVisitId: 'Sunrise Enclave (Mokila)',
  ...
  },
  {
    ...
    description: 'Full tank diesel refill (52.5 Litres) before customer site trip to Mokila.',
    amount: 5400,
    ...
    linkedVehicleId: 'TS 09 UB 1001 (Innova Crysta)',
  ...
  },
  {
    ...
    title: 'Meta Ads Lead Generation Campaign - Sunrise Enclave',
    ...
    linkedCampaignId: 'Mokila Phase 1 Digital Drive',
  ...
  },
  {
    ...
    description: 'Diesel for weekend group site trip (Shadnagar & Kothur ventures).',
    amount: 6200,
    expenseDate: '2026-09-08',
    paymentMode: 'CASH',
    status: 'PENDING',
    ...
    linkedVehicleId: 'TS 08 EX 4050 (Tempo Traveller)',
  ...
  },
  {
    ...
    linkedSiteVisitId: 'Green Valley Phase 2 (Shadnagar)',
  ...
  },
  {
    ...
    category: 'MARKETING_CAMPAIGN',
    title: 'Drone Shoot & 4K Video Production for Palm County Kollur',
    ...
    linkedCampaignId: 'Palm County Kollur Launch Drive',
  ...
  },
  {
    ...
    description: 'Petrol refill for airport NRI client pickup to Mokila site.',
    amount: 3200,
    ...
    approvedBy: {
      ...
      remarks: 'Airport trip verified in vehicle log.',
    },
    linkedVehicleId: 'TS 07 HK 2020 (Ertiga)',
  ...
  },
  {
    ...
    linkedSiteVisitId: 'Palm County (Kollur)',

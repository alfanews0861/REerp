...
export const mockDashboardService = {
  getDashboardData: async (): Promise<DashboardData> => {
    ...
    return {
      ...
      pendingApprovals: 5,
      todayFollowupsList: [
        { id: '1', name: 'Dr. Haritha Rao', task: 'NRI Plot Reservation Agreement for ISKON City - 2 #IC-102' },
        { id: '2', name: 'Venkat Raman', task: 'Bank loan legal verification callback for Dream City #DC-204' },
        { id: '3', name: 'Lakshmi Prasanna', task: 'Discuss corner villa plot IB-05 payment schedule & discount' },
        { id: '4', name: 'Satyanarayana Murthy', task: 'Township boundary survey demarcation report sharing' },
      ],
      topPerformingEmployee: 'Priya Sharma (Zonal Sales Head)',
      topCampaign: 'Akshaya Tritiya Mega Launch 2026',
      topProject: 'ISKON City - 2 (Podalakur Road)',
      pendingTasks: 4,
      upcomingSiteVisits: 8,
      notifications: [
        'Token advance ₹5,00,000 received for Plot IC-102 (ISKON City - 2)',
        'NRI delegation group tour confirmed for Sunday morning at Podalakur Road site',
        'NUDA technical sanction issued for Dream City Phase 2 extension',
      ],
      recentActivities: [

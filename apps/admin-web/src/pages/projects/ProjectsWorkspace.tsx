...
export const SEED_PROJECTS: Project[] = [
  {
    ...
    approvalNumber: '000182/LO/Plg/HMDA/2024',
    reraId: 'P02400004910',
    totalAreaAcres: 38,
    ...
    location: {
      ...
      googleMapsUrl: 'https://maps.google.com/?q=Mokila+Hyderabad',
    },
    members: {
      companyId: 'comp-1',
      branchId: 'branch-1',
  ...
  },
  {
    ...
    location: {
      ...
      district: 'Ranga Reddy',
      mandal: 'Farooqnagar',
      village: 'Shadnagar Highway',
      surveyNumbers: ['Sy. No. 210', '211/1', '212/A'],
      googleMapsUrl: 'https://maps.google.com/?q=Shadnagar+Hyderabad',
    },
    members: {
      companyId: 'comp-1',
      branchId: 'branch-1',
  ...
  {
    id: 'proj-3',
    name: 'Palm County Villa Plots',
    code: 'PCV-01',
    projectType: 'VILLA',
    status: 'ACTIVE',
    approvalAuthority: 'HMDA',
    approvalNumber: '000210/LO/Plg/HMDA/2025',
    reraId: 'P02400006742',
    totalAreaAcres: 22.5,
  ...
  {
    id: 'proj-4',
    name: 'Temple View Hills',
    code: 'TVH-03',
    projectType: 'RESIDENTIAL',
    status: 'ACTIVE',
    approvalAuthority: 'YTDA',
    approvalNumber: '12/YTDA/2024',
    reraId: 'P02400008124',
    totalAreaAcres: 45,
    ...
    location: {
      ...
      village: 'Raigiri Hills',
      surveyNumbers: ['Sy. No. 301', '304/A'],
      googleMapsUrl: 'https://maps.google.com/?q=Yadagirigutta',
    },
    members: {
      companyId: 'comp-1',
      branchId: 'branch-1',
  ...
  {
    id: 'proj-5',
    name: 'Aero Classic Meadows',
    code: 'ACM-01',
    projectType: 'RESIDENTIAL',
    status: 'COMPLETED',
    approvalAuthority: 'HMDA',
    approvalNumber: '000095/LO/Plg/HMDA/2023',
    reraId: 'P02400002190',
    totalAreaAcres: 30,
    layoutMapUrl: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=1200&q=80',
    featured: false,
    location: {
      ...
      district: 'Ranga Reddy',
      mandal: 'Maheshwaram',
      village: 'Tukkuguda Airport Road',
      surveyNumbers: ['Sy. No. 71/B', '72'],
      googleMapsUrl: 'https://maps.google.com/?q=Tukkuguda+Hyderabad',
    },
    members: {
      companyId: 'comp-1',
      branchId: 'branch-1',

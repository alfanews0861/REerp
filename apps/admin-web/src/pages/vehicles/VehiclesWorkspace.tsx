...
export const SEED_DRIVERS: Driver[] = [
  {
    ...
    licenseNumber: 'AP-26-2015-0048123',
    status: 'AVAILABLE',
    assignedVehicleId: 'veh-1',
    assignedVehicleName: 'Toyota Innova Crysta (AP 26 UB 1001)',
    totalTripsCount: 148,
    rating: 4.9,
  },
  {
    ...
    licenseNumber: 'AP-26-2017-0092144',
    status: 'ON_TRIP',
    assignedVehicleId: 'veh-2',
    assignedVehicleName: 'Force Tempo Traveller (AP 26 EX 4050)',
    totalTripsCount: 215,
    rating: 4.8,
  },
  {
    ...
    licenseNumber: 'AP-26-2019-0012399',
    status: 'AVAILABLE',
    assignedVehicleId: 'veh-3',
    assignedVehicleName: 'Maruti Suzuki Ertiga (AP 26 HK 2020)',
    totalTripsCount: 92,
    rating: 4.7,
  },
  {
    ...
    licenseNumber: 'AP-26-2016-0078120',
    status: 'ON_TRIP',
    assignedVehicleId: 'veh-4',
    assignedVehicleName: 'Mahindra Scorpio-N (AP 26 Z 8899)',
    totalTripsCount: 174,
    rating: 4.9,
  },
  {
    ...
    licenseNumber: 'AP-26-2021-0034112',
    status: 'AVAILABLE',
    assignedVehicleId: 'veh-5',
    assignedVehicleName: 'Toyota Innova Hycross (AP 26 FA 3311)',
    totalTripsCount: 68,
    rating: 4.8,
  },
  {
    ...
    licenseNumber: 'AP-26-2018-0065231',
    status: 'ON_TRIP',
    assignedVehicleId: 'veh-6',
    assignedVehicleName: 'Tata Winger Luxury (AP 26 WL 7788)',
    totalTripsCount: 126,
    rating: 4.8,
  },
  {
    ...
    licenseNumber: 'AP-26-2020-0089145',
    status: 'AVAILABLE',
    assignedVehicleId: 'veh-7',
    assignedVehicleName: 'Mahindra Thar 4x4 (AP 26 TH 4400)',
    totalTripsCount: 54,
    rating: 4.9,
  },
  {
    ...
    licenseNumber: 'AP-26-2022-0019283',
    status: 'AVAILABLE',
    assignedVehicleId: 'veh-8',
    assignedVehicleName: 'Toyota Fortuner 4x4 (AP 26 TF 9900)',
    totalTripsCount: 42,
    rating: 5.0,
  },
];
...
export const SEED_VEHICLES: Vehicle[] = [
  ...
  {
    id: 'veh-2',
    registrationNumber: 'AP 26 EX 4050',
...
export const SEED_TRIPS: OdometerLog[] = [
  {
    ...
    vehicleId: 'veh-2',
    vehicleName: 'Force Tempo Traveller (AP 26 EX 4050)',
    driverId: 'drv-2',
    driverName: 'Suresh Kumar',
    tripType: 'SITE_VISIT',
    siteVisitProjectName: 'ISKON City - 2 (Podalakur Road)',
    customerName: 'NRI Investors Delegation from Dallas (12 Pax)',
    startOdometerKm: 64020,
    startTime: '2026-09-09T09:30:00Z',
    notes: 'Direct site visit from RKRI Towers Nellore office with executive refreshments and lunch buffet.',
    status: 'ACTIVE',
  },
  {
    id: 'trip-2',
    ...
    vehicleId: 'veh-4',
    vehicleName: 'Mahindra Scorpio-N (AP 26 Z 8899)',
    driverId: 'drv-4',
    driverName: 'Prakash Rao',
    tripType: 'SITE_VISIT',
    siteVisitProjectName: 'Dream City (Kovuru Highway)',
  ...
  },
  {
    ...
    vehicleId: 'veh-6',
    vehicleName: 'Tata Winger Luxury (AP 26 WL 7788)',
    driverId: 'drv-6',
    driverName: 'K. Mallesh',
    tripType: 'SITE_VISIT',
    siteVisitProjectName: 'ISKON Brundhavanam (Chinthareddypalem)',
    customerName: 'Nellore Urban Investors Group (8 Pax)',
    startOdometerKm: 22710,
    startTime: '2026-09-09T10:30:00Z',
    notes: 'Pickup from Annamayya Circle; site tour with sales exec Anand Naidu.',
    status: 'ACTIVE',
  },
  {
    id: 'trip-4',
    ...
    vehicleId: 'veh-1',
    vehicleName: 'Toyota Innova Crysta (AP 26 UB 1001)',
    driverId: 'drv-1',
    ...
    notes: 'Completed site visit. Customer paid ₹5,00,000 token advance for Plot IC-102.',
    status: 'COMPLETED',
  },
  {
    id: 'trip-5',
    ...
    vehicleId: 'veh-3',
    vehicleName: 'Maruti Suzuki Ertiga (AP 26 HK 2020)',
    driverId: 'drv-3',
    ...
    notes: 'Villa plot boundary inspection completed. Expressed interest in corner plot IB-05.',
    status: 'COMPLETED',
  },
  {
    id: 'trip-6',
    ...
    vehicleId: 'veh-5',
    vehicleName: 'Toyota Innova Hycross (AP 26 FA 3311)',
    driverId: 'drv-5',
    driverName: 'Naresh Reddy',
    tripType: 'SITE_VISIT',
    siteVisitProjectName: 'ISKON Elite Township (Annamayya Circle Extn)',
    ...
    notes: 'Roundtrip inspection of premium residential plots. Customer requested quotation.',
    status: 'COMPLETED',
  },
  {
    id: 'trip-7',
  ...
  },
  {
    ...
    vehicleId: 'veh-7',
    vehicleName: 'Mahindra Thar 4x4 (AP 26 TH 4400)',
    driverId: 'drv-7',
    driverName: 'B. Appa Rao',
    tripType: 'OFFICE_COMMUTE',
    siteVisitProjectName: 'ISKON City - 2 Phase 2 Extension',
  ...
  },
  {
    ...
    vehicleId: 'veh-8',
    vehicleName: 'Toyota Fortuner 4x4 Legender (AP 26 TF 9900)',
    driverId: 'drv-8',

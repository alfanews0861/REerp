...
export const SEED_SITE_VISITS: SiteVisit[] = [
  {
    ...
    meetingLocation: 'Corporate HQ (Jubilee Hills)',
    siteLocation: 'Sunrise Enclave (Mokila)',
    expectedVisitors: 12,
    actualVisitors: 12,
    outcome: 'HOT',
    nextAction: 'Customer reviewing East facing Plot SE-102 pricing deed.',
  ...
  },
  {
    ...
    visitStatus: 'IN_PROGRESS',
    visitMode: 'COMPANY_VEHICLE',
    meetingLocation: 'Gachibowli Branch Office',
    siteLocation: 'Green Valley Phase 2 (Shadnagar)',
    expectedVisitors: 4,
    actualVisitors: 4,
    outcome: 'WARM',
  ...
  },
  {
    ...
    visitMode: 'COMPANY_VEHICLE',
    meetingLocation: 'Wipro Circle, Financial District',
    siteLocation: 'Palm County (Kollur)',
    expectedVisitors: 8,
    outcome: 'HOT',
  ...
  },
  {
    ...
    visitMode: 'COMPANY_VEHICLE',
    meetingLocation: 'Jubilee Hills HO',
    siteLocation: 'Sunrise Enclave (Mokila)',
    expectedVisitors: 2,
    actualVisitors: 2,
    outcome: 'BOOKED',
    linkedBookingId: 'bk-1',
    nextAction: 'Token advance ₹5,00,000 paid for Plot SE-102.',
  ...
  },
  {
    ...
    meetingLocation: 'Madhapur Residence',
    siteLocation: 'Palm County (Kollur)',
    expectedVisitors: 3,
    actualVisitors: 3,
    outcome: 'WARM',
  ...
  },
  {
    ...
    visitStatus: 'COMPLETED',
    visitMode: 'COMPANY_VEHICLE',
    meetingLocation: 'Corporate HQ',
    siteLocation: 'Royal Meadows (Shankarpally)',
    expectedVisitors: 4,
    actualVisitors: 4,
    outcome: 'INTERESTED',
